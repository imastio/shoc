...
public class RedirectUriValidator : IRedirectUriValidator
{
    ...
    public Task<bool> IsRedirectUriValidAsync(string requestedUri, Client client)
    {
        ...
        var allowedUris = client.RedirectUris.ToList();
    ...
    {
        // the set of allowed uris
        var allowedUris = client.PostLogoutRedirectUris.ToList();
    ...
    /// <returns></returns>
    protected static Task<bool> MatchStrictOrLocal(string requestedUri, IEnumerable<string> allowedRedirects)
    {
        // the requested uri
    ...
    /// <param name="requestedUri">The requested URI.</param>
    /// <returns></returns>
    protected static bool ContainsExactUri(IEnumerable<Uri> uris, Uri requestedUri)
    {
        // the request
