...
public class SigningKeyRepository : ISigningKeyRepository
{
    ...
    {
        return this.dataOps.Connect().Query("Identity.Key", "GetBy").ExecuteAsync<SigningKey>(new
        {
            Use = use
        });
    }
    ...
    {
        return this.dataOps.Connect().QueryFirst("Identity.Key", "GetById").ExecuteAsync<SigningKey>(new
        {
            Id = id
        });
    }
    ...
    {
        return this.dataOps.Connect().QueryFirst("Identity.Key", "Create").ExecuteAsync<SigningKey>(key);
    }
    ...
    {
        return this.dataOps.Connect().QueryFirst("Identity.Key", "DeleteById").ExecuteAsync<SigningKey>(new
        {
            Id = id
        });
    }
