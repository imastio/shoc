...
public class AuthorizeAnyAccessAttribute : AuthorizeAttribute, IAsyncAuthorizationFilter
{
    /// <summary>
    ...
    /// </summary>
    public AuthorizeAnyAccessAttribute(params string[] accesses)
    {
        this.AllowedScopes = [];
    ...
    public Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        if (AccessAuthorization.CheckAccess(context.HttpContext, this.accesses, false, this.AllowedScopes?.ToHashSet() ?? new HashSet<string>()))
        {
            return Task.CompletedTask;
        }
