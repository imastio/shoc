...
import WorkspaceSecretsCreateModal from "./workspace-secrets-create-modal";
import WorkspaceSecretsUpdateModal from "./workspace-secrets-update-modal";
import SecretsClient from "@/clients/shoc/secret/secrets-client";
import WorkspaceSecretsDeleteModal from "./workspace-secrets-delete-modal";
import WorkspaceSecretsValueUpdateModal from "./workspace-secrets-value-update-modal";

export function WorkspaceSecretsTable({ workspaceId, loading, onUpdate = () => { } }: any) {
    ...
    return <>
        ...
        />
        <WorkspaceSecretsValueUpdateModal
