...
import WorkspaceLabelsDeleteModal from "./workspace-labels-delete-modal";
import WorkspaceLabelsCreateModal from "./workspace-labels-create-modal";

export function WorkspaceLabelsTable({ workspaceId, loading, onUpdate = () => { } }: any) {
