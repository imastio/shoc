...
export function PrivilegeAccessDeleteModal({privilegeId, open, existing, onClose = () => {}, onSuccess = () => {}}: any){
    ...
    const onOk = async () => {
        ...
        const result = await withToken((token: string) => selfClient(PrivilegeAccessesClient).update(token, privilegeId, {
