...
import UserSecretsCreateModal from "./user-secrets-create-modal";
import UserSecretsUpdateModal from "./user-secrets-update-modal";
import UserSecretsValueUpdateModal from "./user-secrets-value-update-modal";
import UserSecretsDeleteModal from "./user-secrets-delete-modal";

export function UserSecretsTable({ workspaceId, loading, onUpdate = () => { } }: any) {
