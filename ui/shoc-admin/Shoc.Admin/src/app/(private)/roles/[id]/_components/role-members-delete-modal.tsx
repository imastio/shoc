...
export function RoleMembersDeleteModal({roleId, existing, open, onClose = () => {}, onSuccess = () => {}}: any){
    ...
    const onOk = async () => {
        ...
        const result = await withToken((token: string) => selfClient(RoleMembersClient).deleteById(token, roleId, existing?.id ));
