...
export function UserAccessDeleteModal({userId, open, existing, onClose = () => {}, onSuccess = () => {}}: any){
    ...
    const onOk = async () => {
        ...
        const result = await withToken((token: string) => selfClient(UserAccessesClient).update(token, userId, {
