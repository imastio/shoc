...
import SecretCreateDialog from "./secret-create-dialog"
import SecretUpdateDialog from "./secret-update-dialog"
import SecretValueUpdateDialog from "./secret-value-update-dialog"
import SecretDeleteDialog from "./secret-delete-dialog"

export default function SecretsTable({ workspaceId, className }: { workspaceId: string, className?: string }) {
  ...
  const load = useCallback(async (workspaceId: string) => {
    ...
    setProgress(true);
    const { data, errors } = await rpc('secret/workspace-secrets/getAll', { workspaceId })
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                disabled={!hasAny([WorkspacePermissions.WORKSPACE_UPDATE_SECRET])}
              >
              ...
              <DropdownMenuItem
                ...
                disabled={!hasAny([WorkspacePermissions.WORKSPACE_DELETE_SECRET])}
              >
